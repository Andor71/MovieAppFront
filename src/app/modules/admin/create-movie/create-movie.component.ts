...
export class CreateMovieComponent implements OnInit {
  ...
  constructor(private authorService: AuthorService, private movieService: MovieService, private router: Router) { }
  ...
  createMovie(){
    ...
    this.newMovie.authorDto = this.authors.filter(author => author.id == this.selectedAuthorId)[0];
